  ...
  template: `
    <section class="relative min-h-screen w-full bg-white">
      ...
      <div class="relative z-1 flex h-50 items-center justify-center overflow-hidden bg-black">
        <h1 class="m-0 w-full px-[1vw] text-center font-['area-normal',sans-serif] text-[clamp(4.5rem,15.8vw,17rem)] leading-none font-bold uppercase tracking-[-0.03em] text-white opacity-100" data-hero-title>YNARCHIVE</h1>
      </div>
